%% |isopenocean| documentation 
% The |isopenocean| function returns logical true for any locations that are neither grounded nor ice shelf  
% according to MEaSURES Antarctic Boundaries for IPY 2007-2009 from Satellite Radar, Version 2. The |isopenocean| 
% function returns the logical NOT of the |isice| function. 
% 
...
%% Description
% 
% |tf = isopenocean(lati,loni)| returns true for all geo locations |(lati,loni)| for all locations that are not
% part of the ice sheet ice in the Mask_Antactica_v2.tif (sic) dataset. 
%  
% |tf = isopenocean(xi,yi)| returns true for all non-ice-sheet locations in Mask_Antactica_v2.tif (sic), where
