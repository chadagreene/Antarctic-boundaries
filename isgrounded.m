function tf = isgrounded(lati_or_xi,loni_or_yi)
% isgrounded returns logical true wherever there is grounded Antarctic ice 
...
%% Syntax
% 
%  tf = isgrounded(lati,loni)
%  tf = isgrounded(xi,yi) 
% 
%% Description
% 
% tf = isgrounded(lati,loni) returns true for all geo locations (lati,loni) identified as grounded
% ice in the Mask_Antactica_v2.tif (sic) dataset. 
%  
% tf = isgrounded(xi,yi) returns true for all locations identified as grounded ice in Mask_Antactica_v2.tif (sic), where
